...
## Step-5: Creating a web application where we can post our querry and get predictions

#### Flask
- A simple light weight web server gateway interface, that is used to prototype and host the machinelearning models

- step-1: Edit the index.html page in template (generated by template.py)
